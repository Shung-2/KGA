...
{
	_background = IMAGEMANAGER->addImage("배경", "롤로딩.bmp", WINSIZEX, WINSIZEY, true, RGB(255, 0, 255));
...
DWORD CALLBACK threadFunction(LPVOID lpParameter)
{
	...
	{
		IMAGEMANAGER->addImage("시작", "롤시작.bmp", WINSIZEX, WINSIZEY, true, RGB(255, 0, 255));
